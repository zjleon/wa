...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        concat: {
            ...
            almond: {
                src: ['<%= pkg.path.lib %>/<%= pkg.file.closureHead %>', '<%= pkg.path.lib %>/<%= pkg.file.almond %>', '<%= pkg.path.lib %>/<%= pkg.file.promise %>', '<%= pkg.path.tmpDir %>/<%= pkg.file.amdBuilded %>', '<%= pkg.path.lib %>/<%= pkg.file.closureFoot %>'],
